...
<main id="primary" class="berck-site">
    <section class="berck-hero" id="top">
        ...
        <div class="berck-hero-content container">
            ...
            <div class="berck-live-pill">2 personnes regardent ce bien</div>
            ...
            <div class="berck-hero-metrics">
                <article><strong>50m</strong><span>de la plage</span></article>
                <article><strong>4/5</strong><span>note moyenne</span></article>
                <article><strong>2 min</strong><span>pour reserver</span></article>
            </div>
        </div>
    </section>
    ...
    <section class="berck-section" id="appartements">
        <div class="container">
            ...
            <div class="berck-cards">
                <?php foreach ($apartments as $card_index => $apt) : ?>
                    <article class="berck-card berck-reveal" style="--reveal-delay: <?php echo esc_attr((string) ($card_index * 90)); ?>ms;">
    ...
    <section class="berck-section" id="galerie">
        <div class="container">
            ...
            <div class="berck-slider" data-berck-slider>
                ...
                <div class="berck-slider-count"><span data-berck-current>1</span> / <?php echo esc_html((string) count($gallery)); ?></div>
            </div>
        </div>
    </section>
    ...
    <a href="#reservation" class="berck-fab">Reserver maintenant</a>
</main>
<?php
get_footer();
